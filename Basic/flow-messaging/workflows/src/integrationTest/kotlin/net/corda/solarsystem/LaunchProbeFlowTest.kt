...
class LaunchProbeFlowTest {
    ...
    private fun launchProbeFlowParams(message: String, target: String): String {
        return GsonBuilder()
            .create()
            .toJson(mapOf("message" to message, "target" to target))
    }
